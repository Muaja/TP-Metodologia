...
<div class="container-fluid mb-4">
    <div class="col-sm-12 col-md-10 offset-sm-0 offset-md-1 bg-custom-transparent rounded shadow p-3">
        ...
        <h2 class="col-12 border-bottom border-gray pb-2 mb-0 text-white">Funciones disponibles <?php if($idPelicula != null) { ?> de <?php echo $pelicula->getTitulo(); ?><?php } ?></h2>
            ...
            if(!empty($cineList))
            {
                foreach ($cineList as $funcionCine) 
                { 
            ...
            ?>
                    ...
                    <div class="container-fluid my-4">
                        <div class="col-12 bg-dark-transparent rounded shadow p-3">
                ...
                <div class="container-fluid">
                    <div class="alert alert-danger mt-3" role="alert">
                        ...
                        <div class="col col-auto">
                            <?php if($this->isAdmin()) { ?>
                            <h4 class="alert-heading">No existen funciones.</h4>
                            <ul>
                            <li>
                                Intenta crear una funcion.
                            </li>
                            <li>
                                Primero deben crearse peliculas y cines.
                            </li>
                            </ul>
                            <?php } else { ?>
                            <ul>
                            <li>
                                Recarga la pagina para ver las ultimas funciones.
                            </li>
                            </ul>
                            <?php } ?>
                        </div>
